...
import 'package:habits_flow/ui/screens/active_habits/screen/active_habits_screen_state.dart';

import 'active_habits_app_bar.dart';
import 'habit_selected_app_bar.dart';

class HabitsAppBarBuilder extends StatelessWidget
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ActiveHabitsScreenCubit, ActiveHabitsScreenState>(
        ...
        previous.uiModel != current.uiModel ||
